...
import { isAutenticado } from '../services/authService';
...
export default function AppNavigator() {
  ...
  useEffect(() => {
    isAutenticado().then(setAutenticado);
  }, []);

  if (autenticado === null) {
    return <View style={{ flex: 1, justifyContent: 'center' }}><ActivityIndicator size="large" color="#1565C0" /></View>;
  }
